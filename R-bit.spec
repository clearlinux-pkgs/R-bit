...
Version  : 1.1.13
Release  : 13
URL      : https://cran.r-project.org/src/contrib/bit_1.1-13.tar.gz
Source0  : https://cran.r-project.org/src/contrib/bit_1.1-13.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1526525805
